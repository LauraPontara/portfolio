...
export default function Home() {
  return (
    <div className="bg-background relative flex min-h-screen items-center justify-center font-sans transition-colors duration-300">
      ...
      <main className="pointer-events-none relative z-10 flex min-h-screen w-full max-w-7xl flex-col items-center justify-between px-16 py-32 sm:items-start">
        ...
        <div className="flex w-full flex-col gap-4 text-base font-medium sm:flex-row">
          <button className="bg-brand-5 shadow-brand-5/20 pointer-events-auto flex h-14 w-full items-center justify-center gap-2 rounded-2xl px-8 text-white shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98] md:w-auto">
            Enviar mensagem
          </button>
        </div>
