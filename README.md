...
- **Organização do repositório:** Clareza do código e estrutura de pastas
- **Alinhamento com protótipos:** Fidelidade ao design proposto
- **Funcionamento da hospedagem:** Site acessível e sem erros na nuvem
- **README completo:** Documentação clara e completa

> ⚠️ **Atenção:** Semanalmente, todos os grupos deverão apresentar o andamento das entregas durante a aula. A não participação implica em perda automática de 50% dos pontos da sprint.

> ⏰ **Prazo:** Desconto de 1.0 ponto por dia de atraso.
